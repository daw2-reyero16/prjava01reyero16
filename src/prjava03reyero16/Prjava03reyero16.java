...
public class Prjava03reyero16 extends Frame implements ActionListener, WindowListener{
...
// This class acts as listener for ActionEvent and WindowEvent 
   ...
   public Prjava03reyero16 () { 
      ...
      setTitle(" nova finestra prjava03reyero16");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03reyero16();  // Let the construct do the job 
   } 
